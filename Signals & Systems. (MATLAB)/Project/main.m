...
set(gcf,'Units','centimeters','position',[1 2 49 24],'Name','DTMF'); % UI Window Position

bip=[100,600]; % button inital position
bs=60; % button inital size

AuthorDisplay=uicontrol('Style', 'text', 'Position',[bip+[0 bs*3],320,35],'String', 'DTMF Encoder Decoder','FontSize',20,'HorizontalAlignment','left','BackgroundColor',[0.937 0.867 0.867]);
...
set(buttonStar,'Callback','button_Asterisk'); % button reaction and call function button_Star
...
set(buttonSign,'Callback','button_Hash'); % button reaction and call function button_Sign
